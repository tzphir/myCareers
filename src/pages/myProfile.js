       ...
       <div id="myprofile">
            ...
            <div className="container" id="personal-info">
                <div className="types-personal-info">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type='text' name="fname" value={personalInfo.fname} onChange={handleChange}></input><br/>
                        ...
                        <input type='text' id="faculty" value={personalInfo.faculty} onChange={handleChange}></input><br/>
            ...
            <div className="container" id="applications">
                <div className="applications-content">
                    ...
                    <button type="button" className="search-more-button">Search More</button>
                </div>
            </div>
       </div>
    );

 ...
 * @response 201 {id, title, company, date, location, type, term, duration, format, modality, language, description}
...
router.post("/", async (req, res) => {
  try {
    ...
    // Check if an job posting with the same title, company, date, and location already exists
 ...
 * @response 200 [{id, title, company, date, location, type, term, duration, format, modality, language, description}]
...
/**
 * @description Get all job postings by any field (Except description & need at least one field)
 ...
 * @response 200 [{id, title, company, date, location, type, term, duration, format, modality, language, description}]
 * @response 404 {error: "No job found"}
...
router.get("/", async (req, res) => {
  try {
    ...
    // Search for job postings based on the dynamic query object

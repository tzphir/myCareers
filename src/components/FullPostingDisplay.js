...
const req = {
    ...
    const handleApply = async () => {
        ...
        try{
            await axios.post(`http://localhost:8000/Users/${localStorage.getItem("_id")}/jobPostings`,req);
        }catch (error){
    ...
    <div className="top-container">
        ...
        <div className="top-square">
            <div className="top-left-square">
                ...
                <div className="star">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill='red'  className='star' >

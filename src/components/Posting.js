...
const Posting = ( {jobPosting, setSelectedPost, selectedPost, isStarred, onStarChange} ) => {
    ...
    return(
        <div className={postingClass}>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill={starColor} className='star' onClick={handleStarredPosting}>
            ...
            <div className="logo">
                <img src={Logo} alt="Company Logo" onClick={handlePostClick} className="logo" style={{marginTop:"5px"}}/>
            </div>
